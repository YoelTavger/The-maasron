...
"""
               ...
               bot.send_message(chat_id, "⚠️ אירעה שגיאה ביצירת משק הבית.", reply_markup=get_settings_keyboard())
       except Exception as e:
...
"""
           ...
           bot.send_message(chat_id, "⚠️ אירעה שגיאה בהצטרפות למשק הבית.", reply_markup=get_settings_keyboard())
   ...
   def handle_household_confirmations(call):
       ...
       if data == "confirm_new_household":
           ...
           try:
               ...
               bot.send_message(chat_id, "⚠️ אירעה שגיאה ביציאה ממשק הבית.", reply_markup=get_settings_keyboard())
